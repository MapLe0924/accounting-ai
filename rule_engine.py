...
RULE_DATABASE = [
    ...
    # ── 往来款项 ──
    {"keywords": ["采购 未付", "采购 尚未 支付", "赊购 材料", "原材料 未付", "材料 入库 未付", "价款 未付", "货款 尚未 支付", "货款 尚未", "尚未 支付 材料"], "debit": "__MULTI_ENTRY__:mock_data:140", "credit": "__MULTI_ENTRY__:mock_data:140", "description": "采购原材料含税赊购（材料入库，款未付）", "warning": "材料已入库但货款未付，确认应付账款；专票进项税额可抵扣。", "_multi_entry": True, "_mock_id": 140},
